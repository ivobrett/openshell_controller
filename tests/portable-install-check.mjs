...
assert.match(versionedInstallSource, /NEMOCLAW_INSTALL_REF="\$\{NEMOCLAW_INSTALL_REF:-\$\{NEMOCLAW_INSTALL_TAG:-v0\.0\.78\}\}"/, 'versioned installer must pin NemoClaw to tag v0.0.78 (first tag carrying OpenClaw 2026.6.10)')
